...
"[project]/JobPortal/frontend/node_modules/next/dist/compiled/conf/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(()=>{
    var e = {
        ...
        9041: (e, r, t)=>{
            ...
            const p = "aes-256-cbc";
            delete __turbopack_context__.c["TURBOPACK compile-time value", "/ROOT/JobPortal/frontend/node_modules/next/dist/compiled/conf/index.js"];
                        ...
                        if (this.encryptionKey) {
                            try {
                                if (e.slice(16, 17).toString() === ":") {
                                    ...
                                    e = __TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat([
                                        a.update(e.slice(17)),
                                        a.final()
                                    ]);
                                } else {
                ...
                set store(e) {
                    ...
                    if (this.encryptionKey) {
                        ...
                        r = __TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat([
                            e,
                            __TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(":"),
                            a.update(__TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(r)),
                            a.final()
                        ]);
                    }
                    h.sync(this.path, r);
        ...
        5634: (e, r, t)=>{
            ...
            const i = s.homedir();
            const o = s.tmpdir();
            const { env: n } = __TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
            const macos = (e)=>{
 ...
 */ (function() {
        ...
        5940: (e, r, t)=>{
            ...
            const o = t(7849);
            const n = o.satisfies(__TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].version, ">=10.12.0");
            const checkPath = (e)=>{
                if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
                ;
            };
        ...
        7234: (e, r, t)=>{
            var a = /*TURBOPACK member replacement*/ __turbopack_context__.g.process;
            ...
            if (!processOk(a)) {
                ...
                var f = function unload() {
                    if (!h || !processOk(/*TURBOPACK member replacement*/ __turbopack_context__.g.process)) {
                        return;
                    }
                    h = false;
        ...
        1449: (e, r, t)=>{
            ...
            e.exports = function typedarrayToBuffer(e) {
                if (a(e)) {
                    var r = __TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e.buffer);
                    if (e.byteLength !== e.buffer.byteLength) {
                        r = r.slice(e.byteOffset, e.byteOffset + e.byteLength);
                    }
                    return r;
                } else {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e);
                }
            };
        },
        4856: function(e, r) {
        ...
        6363: (e, r, t)=>{
            ...
            function getTmpname(e) {
                return e + "." + s(("TURBOPACK compile-time value", "/ROOT/JobPortal/frontend/node_modules/next/dist/compiled/conf/index.js")).hash(String(__TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].pid)).hash(String(u)).hash(String(++h)).result();
            }
                ...
                try {
                    ...
                    if (!t.mode || !t.chown) {
                        ...
                        if (e) {
                            ...
                            if (t.chown == null && __TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getuid) {
                                t.chown = {
                                    uid: e.uid,
                                    gid: e.gid
                                };
            ...
            function writeFileSync(e, r, t) {
                ...
                if (!t.mode || !t.chown) {
                    try {
                        ...
                        if (!t.chown && __TURBOPACK__imported__module__$5b$project$5d2f$JobPortal$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getuid) {
                            t.chown = {
                                uid: r.uid,
                                gid: r.gid
                            };
        ...
        5055: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/JobPortal/frontend/node_modules/next/dist/compiled/find-up/index.js [app-client] (ecmascript)");
        },
        7849: (e)=>{
            "use strict";
    ...
    if (typeof __nccwpck_require__ !== "undefined") __nccwpck_require__.ab = ("TURBOPACK compile-time value", "/ROOT/JobPortal/frontend/node_modules/next/dist/compiled/conf") + "/";
...
//# sourceMappingURL=661c0_next_dist_compiled_conf_index_7ac5ee3a.js.map