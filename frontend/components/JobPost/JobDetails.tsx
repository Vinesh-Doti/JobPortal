...
function JobDetails() {
  const {salary,handleSalaryChange,salaryType,setSalaryType,setNegotiable,negotiable}=useGlobalContext();
  return (
        ...
        <div>
          ...
          <div className='flex gap-2 mt-2 justify-between'>
            <div className='flex items-center space-x-2 border border-gray-300 rounded-md p-2'>
              ...
              <Label htmlFor='negotiable' className='text-gray-500'>Negotiable</Label>
            </div>
            <div className='flex items-center space-x-2 border border-gray-300 rounded-md p-2'>
              <Checkbox id="hideSalary" checked={negotiable} onCheckedChange={setNegotiable}/>
              <Label htmlFor='salary' className='text-gray-500'>Hide Salary</Label>
            </div>
            <div>
              <Select onValueChange={setSalaryType}>
                ...
                <SelectContent className="w-[120px] mt-2" position="popper">
