...
function JobForm() {
    ...
    const renderStages=()=>{
      switch(currentSection){
        case "About" : return <JobTitle/>;
        case "Job Details": return <JobDetails/>;
        case "Skills": return <JobSkills/>;
        case "Location":return <JobLocation/>;
      }
    };
  ...
  return (
    <div className='w-full flex gap-6'>
        ...
        >
          ...
          {currentSection==="Summary" && <button type='submit' className='self-end px-6 py-2 bg-[#7263f3] text-white rounded-md'>Post Job</button>}
        </form>
    </div>
  )
};
